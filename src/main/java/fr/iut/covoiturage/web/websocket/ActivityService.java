package fr.iut.covoiturage.web.websocket;

import fr.iut.covoiturage.security.SecurityUtils;
import fr.iut.covoiturage.web.websocket.dto.ActivityDTO;
...
import static fr.iut.covoiturage.config.WebsocketConfiguration.IP_ADDRESS;
