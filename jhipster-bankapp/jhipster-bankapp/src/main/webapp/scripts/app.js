...
var ecommerceApp = angular.module('ecommerceApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'ecommerceAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
